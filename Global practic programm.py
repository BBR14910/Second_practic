...
for i in sys.stdin:
    choose_programm = int(input("Введите целочисленное число для выбора программы (1 - найти скорость; "
                                ...
                                "энергию; 7 - найти давление; 8 - найти теплоту; 9 - найти частоту; 10 - найти объем"
                                ") \n"))
    ...
    elif choose_programm == 10:
        radious = float(input("Введите радиус основания цилиндра в м\n"))
        high = float(input('Введите высоту цилиндра в м\n'))
        print("Объем = ", pi*(radious**2)*high, ' м^3\n')
